 ...
 * CS42L83 I2C register routines split out from cirrus_apple.c.
 */
...
/* ---- begin inlined patch_cirrus_real84_i2c.h ---- */
...
void cs42l83_headset_button_detect_interrupts_off(struct hda_codec *codec)
{
	...
	mycodec_i2c_local_info(codec, "%s\n", __func__);
...
//      snd_hda i2cPagedWrite i2c address 0x90 i2c reg hi 0x1b lo 0x741f i2c data 0x001f
	...
	if ((~ret_mask & 0x18) != 0x18) {
		codec_dbg(codec, "%s invalid mask 0x%08x\n", __func__, ret_mask);
		return 0;
	}
...
//      snd_hda i2cPagedWrite i2c address 0x90 i2c reg hi 0x12 lo 0x0800 i2c data 0x0000
	...
	mycodec_i2c_local_info(codec, "%s end\n", __func__);
}
...
/* ---- end inlined patch_cirrus_real84_i2c.h ---- */
